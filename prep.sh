...
/mnt/c/Program\ Files/JetBrains/IntelliJ\ IDEA\ 2022.3.2/bin/idea64.exe ./src/test/resources/"$1"/day"${DAYSTRING}"/day"${DAYSTRING}".input
/mnt/c/Program\ Files/JetBrains/IntelliJ\ IDEA\ 2022.3.2/bin/idea64.exe ./src/test/resources/"$1"/day"${DAYSTRING}"/day"${DAYSTRING}".sample1

/mnt/c/Program\ Files/JetBrains/IntelliJ\ IDEA\ 2022.3.2/bin/idea64.exe ./src/main/kotlin/solution/_"$1"/Day"${DAYSTRING}".kt
/mnt/c/Program\ Files/JetBrains/IntelliJ\ IDEA\ 2022.3.2/bin/idea64.exe ./src/test/kotlin/solution/_"$1"/Day"${DAYSTRING}"Test.kt
