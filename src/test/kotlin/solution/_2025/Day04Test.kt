...
class Day04Test {
    ...
    inner class Solve1 {
        @Test
        fun sample1() {
            val input = File("./src/test/resources/2025/day04/day04.sample1").readLines()
        ...
        @Test
        fun answer() {
            val input = File("./src/test/resources/2025/day04/day04.input").readLines()
            val result = Day04(input).solve1()
    ...
    inner class Solve2 {
        ...
        fun answer() {
            ...
            assertThat(result).isEqualTo(8013)
        }
    }
